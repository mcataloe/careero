...
unless explicitly requested. Application timelines can reference cover-letter
artifact created, reviewed, submitted, and archived events, but timeline metadata
must not include cover-letter body content or internal COMPASS analysis.
